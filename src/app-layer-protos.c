...
const AppProtoStringTuple AppProtoStrings[ALPROTO_MAX] = {
    ...
    { ALPROTO_MYSQL, "mysql" },
	{ ALPROTO_DB2, "db2" },
	{ ALPROTO_ORACLE, "oracle" },
	{ ALPROTO_SQLSERVER, "sqlserver" },
	{ ALPROTO_GITSMART, "gitsmart" },
	{ ALPROTO_LDAP, "ldap" },
	{ ALPROTO_KRB5, "krb5" },
	{ ALPROTO_MONGODB, "mongodb" },
	{ ALPROTO_REDIS, "redis" },
	{ ALPROTO_RADIUS, "radius" },
	{ ALPROTO_CASSANDRA, "cassandra" },
	{ ALPROTO_KINGBASE, "kingbase" },
	{ ALPROTO_HANA, "hana" },
	{ ALPROTO_TIDB, "tidb" },
	{ ALPROTO_DMDB, "dmdb" },
	{ ALPROTO_MARIADB, "mariadb" },
