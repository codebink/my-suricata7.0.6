...
#define HAVE_BPF_PROGRAM__SECTION_NAME 1

/* Define to 1 if you have the `bpf_program__set_type' function. */
#define HAVE_BPF_PROGRAM__SET_TYPE 1
...
#define HAVE_PF_RING_FLOW_OFFLOAD 1
...
#define PACKAGE_STRING "suricata 7.0.6"
