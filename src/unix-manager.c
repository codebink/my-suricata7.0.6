...
static TmEcode UnixManagerPluginsReloadCommand(json_t *cmd,
                                   json_t *server_msg, void *data)
{
    ...
    filename = suricata.conf_filename;
    ...
    json_object_set_new(server_msg, "message", json_string("Plugins reload Closing Suricata"));
...
int UnixManagerInit(void)
{
    ...
    /* Init Unix socket */
    UnixManagerRegisterCommand("plugins-reload", UnixManagerPluginsReloadCommand, NULL, 0);
