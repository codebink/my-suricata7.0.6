...
void SigTableSetup(void)
{
    ...
    DetectDNP3Register();
    DetectMysqlRegister();
    DetectMariadbRegister();
	DetectDb2Register();
	DetectDmdbRegister();
	DetectTidbRegister();
	DetectHanaRegister();
	DetectKingbaseRegister();
	DetectCassandraRegister();
	DetectRadiusRegister();
	DetectRedisRegister();
	DetectMongodbRegister();
	DetectKrb5Register();
	DetectLdapRegister();
	DetectGitsmartRegister();
	DetectSqlserverRegister();
	DetectPgsqlRegister();
	DetectOracleRegister();
